...
//import com.homepageTest.board.domain.entity.Category;
...
//        System.out.println(boardDtoList);
    ...
    public String write(BoardDto boardDto) {
        ...
        System.out.println(boardService.savePost(boardDto));
    ...
    public String test2(@PathVariable("categoryId")int categoryId,Model model){
...
//    public String test3(@PathVariable("categoryId") Category categoryId, BoardDto boardDto){
//        System.out.println(boardDto);
//        boardDto.setCategory_id(categoryId);
//        System.out.println(boardService.insertBoard(categoryId,boardDto));
//        System.out.println(categoryId);
//        return "redirect:/";
//    }
